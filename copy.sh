...
cd ..
copier copy -fd "project_name=$library_repo_name" -fd "github_repo_name=$library_repo_name" -a .copier-answers-mattia.yaml --trust gh:Eye-Tech-AI/pyet-boilerplate-package "$library_repo_name"
